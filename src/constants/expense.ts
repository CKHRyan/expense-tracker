...
export const categoryGroupMap: Record<Category, CategoryGroup> = {
  ...
  Kitchenware: CATEGORY_GROUP.Life,
  ...
  Ticket: CATEGORY_GROUP.Vacation,
  Transport: CATEGORY_GROUP.Vacation,
  Snack: CATEGORY_GROUP.Life,
  HairStyling: CATEGORY_GROUP.Life,
